...
public class Necro_DeadState : DeadState
{
    private Necromancer enemy;
    public Necro_DeadState(Entity entity, FiniteStateMachine stateMachine, string animBoolName, D_DeadState stateData, Necromancer enemy) : base(entity, stateMachine, animBoolName, stateData)
    {
        this.enemy = enemy;
    }
